    ...
    starlight({
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/ArroyoSystems/arroyo",
        },
        {
          icon: "discord",
          label: "Discord",
          href: "https://discord.gg/cjCr5rVmyR",
        },
        {
          icon: "x.com",
          label: "Twitter",
          href: "https://twitter.com/ArroyoSystems",
        },
        {
          icon: "linkedin",
          label: "LinkedIn",
          href: "https://www.linkedin.com/company/arroyo-systems",
        },
      ],
      ...
      sidebar: [
            ...
            { label: "Formats", slug: "connectors/formats" },
            {
              ...
              items: [
                ...
                { label: "Redpanda", slug: "connectors/redpanda" },
                {
                  ...
                  slug: "connectors/server-sent-events",
                },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              label: "Python",
              collapsed: true,
              items: [{ label: "UDFs", slug: "udfs/python/udfs" }],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [{ label: "Developer Setup", slug: "developing/dev-setup" }],
        },
        {
          label: "Releases",
          collapsed: true,
