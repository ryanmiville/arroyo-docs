...
to JSON, which can then be operated on using [SQL json functions](/sql/scalar-functions#json-functions) or [UDFs](/udfs).
...
[UDFs](/udfs), this allows you to implement binary formats that are internal or otherwise
