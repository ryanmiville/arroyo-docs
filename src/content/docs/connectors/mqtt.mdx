...
| max_packet_size | Maximum MQTT packet size in bytes | No | 10240 |
...
See the [connection profile](/connectors#connection-profiles) docs for more details.
...
See the [source metadata](/connectors#source-metadata) docs for more on how to use metadata fields.
