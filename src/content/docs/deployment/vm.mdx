...
Before starting this guide, follow the common setup steps in the [deployment overview](/deployment) guide.
...
[CHECKPOINT_URL and ARTIFACT_URL](/deployment#storage). Note that for a distributed
