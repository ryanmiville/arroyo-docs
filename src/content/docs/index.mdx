...
![Arroyo](/images/header_image.png)
...
See the [getting started guide](/getting-started) to get up and running with a local Arroyo deployment.


### In production

Arroyo supports several deployment targets for production use, including native support for Kubernetes. See the
[deployment docs](/deployment) for more information.
...
team and community are actively engaged in helping users get started and solve their problems with Arroyo.
